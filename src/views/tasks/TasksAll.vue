            ...
            <div v-for="task in tasks" v-bind:key="task._id" class="card mb-2 ml-2 text-white bg-dark" style="width: 18rem;">
                <div class="card-body">
                    <div class="d-flex justify-content-between"> 
                        ...
                        <span v-bind:class="{isLate: taskIsLate(task.dueDate) && !task.completed}" class="small">{{task.dueDate | date}}</span>
                    </div>
            ...
            <div>
                <b-modal id="modal1" ref="modal" centered title="Delete Confirmation">
                    ...
                    <div slot="modal-footer" class="w-100 text-right">
                        <b-button slot="md" class="mr-1" variant="danger" block @click="deleteTask">Delete</b-button>
